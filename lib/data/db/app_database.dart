...
@DriftDatabase(
  tables: [Clients, AnamnesisTable, Measurements, Notes, NutritionCalculations, NutritionPlans],
  daos: [ClientDao, AnamnesisDao, MeasurementDao, NoteDao, NutritionCalculationDao, NutritionPlanDao],
)
